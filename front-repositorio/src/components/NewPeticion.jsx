...
const NewPeticion = ({ isOpenModalS, closeModalS, dataTesis, userData }) => {
  ...
  const [nombreUsuario, setNombreUsuario] = useState(
    userData ? userData.nombre_usuario : ""
  );
  ...
  return (
    ...
    >
      <div
        ...
        onClick={closeModalS}
      ></div>
      <div className="modal-container mt-12 w-[50%] h-[65%] rounded-xl shadow-md p-7  bg-white">
        <button className="absolute top-0 right-0 p-3" onClick={closeModalS}>
          <svg
        ...
        <form className="grid grid-rows-4 grid-cols-2 " onSubmit={onSubmit}>
          <h2 className="col-span-2 text-3xl font-semibold text-center mr-5 ">
            Solicitud de lectura de tesis
          </h2>
          ...
          <div className="col-span-2 flex w-full">
            <label htmlFor="" className="text-lg font-semibold  mr-9">
              Tesis a solicitar:
            </label>
            <input
              className="border w-[60%] h-[50%] p-1 ml-5 shadow-lg hover:bg-red-100 focus:outline-none focus:ring-0 focus:outline-red-500 rounded-md"
          ...
          <div className="col-span-2 flex w-full">
            <label htmlFor="" className="text-lg font-semibold  mr-7">
              Motivo solicitud:
            </label>
            <textarea
          ...
          <section className="mt-10 col-span-2 flex justify-center">
            <button className="bg-red-600 text-white px-12 p-3 w-80% rounded-full hover:bg-gray-700 font-semibold">
              Realizar solicitud
            </button>
          </section>
        </form>
